	    ...
	    <div class="page-wrapper">
	    	<div class="inner-wrapper">
		        ...
		        <div class="info-container">
		        	...
		        	<p>You have a maximum of 5 job posting in this basic free account, renewable after 30days, also each post will be posted in JobFair for 30days. If you want to increase the number posts in your account, please upgrade to Pro or Premium <a href="login.php">here</a>.</p>
		        </div>
	    	</div>
	    </div>
	</div>
